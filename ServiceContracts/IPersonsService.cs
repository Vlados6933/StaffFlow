...
namespace ServiceContracts
{
    ...
    public interface IPersonsService
    {
        ...
        /// </summary>
        /// <param name="personID">Peron id to search</param>
        /// <returns>Returns matching person object</returns>
        Task<PersonResponse?> GetPersonByPersonID(Guid? personID);

        /// <summary>
        /// Returns all person object that matches with the given search field and search sting
        /// </summary>
        ...
        /// </summary>
        /// <param name="personUpdateRequest">Person dateils to update, including person id</param>
        ...
        /// </summary>
        /// <returns>Returns the memoty stream with Excel data of persons</returns>
